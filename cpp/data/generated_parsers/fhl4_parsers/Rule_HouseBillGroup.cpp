...
Rule_HouseBillGroup::Rule_HouseBillGroup(
  const string& spelling, 
  const vector<const Rule*>& rules) : Rule(spelling, rules)
{
}

Rule_HouseBillGroup::Rule_HouseBillGroup(const Rule_HouseBillGroup& rule) : Rule(rule)
{
}

Rule_HouseBillGroup& Rule_HouseBillGroup::operator=(const Rule_HouseBillGroup& rule)
{
  Rule::operator=(rule);
  return *this;
}

const Rule_HouseBillGroup* Rule_HouseBillGroup::clone() const
{
  return new Rule_HouseBillGroup(this->spelling, this->rules);
}

void* Rule_HouseBillGroup::accept(Visitor& visitor) const
{
  return visitor.visit(this);
}

const Rule_HouseBillGroup* Rule_HouseBillGroup::parse(ParserContext& context)
{
  context.push("HouseBillGroup");
  ...
  if (parsed)
  {
    rule = new Rule_HouseBillGroup(context.text.substr(a0.start, a0.end - a0.start), a0.rules);
  }
  else
  {
    context.index = s0;
  ...
  context.pop("HouseBillGroup", parsed);

  return (Rule_HouseBillGroup*)rule;
}
