...
4. **Serve/display** — results are served through a REST API (`/api/*`) to a React client for day-to-day ops use (MAWB/HAWB/ULD tracking, pickup status, and similar operational tables), with edits written back through `PATCH` endpoints.
