...
exports.up = (pgm) => {
  pgm.sql(`
    DROP INDEX IF EXISTS idx_emails_raw_notification_mawb_event;
...
exports.down = () => {
  throw new Error('Down migration is not supported for 1714000010000_add_arrival_notice_notification_support');
};
