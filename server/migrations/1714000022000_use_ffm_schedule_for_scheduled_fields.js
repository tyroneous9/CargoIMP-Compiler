...
exports.up = (pgm) => {
  pgm.sql(`
    ...
    SELECT
      ...
      uld_arrival.scheduled_arrival_date AS scheduled_arrival_date,
      uld_arrival.scheduled_arrival_time AS scheduled_arrival_time,
...
exports.down = () => {
  throw new Error('Down migration is not supported for 1714000022000_use_ffm_schedule_for_scheduled_fields');
};
