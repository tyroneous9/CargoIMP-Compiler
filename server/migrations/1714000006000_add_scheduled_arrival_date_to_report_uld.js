...
exports.up = (pgm) => {
  pgm.sql(`
    ...
    LEFT JOIN LATERAL (
      SELECT
        me.event_date_text AS scheduled_arrival_date,
        me.event_time_text AS scheduled_arrival_time
      FROM mvt_event me
...
exports.down = () => {
  throw new Error('Down migration is not supported for 1714000006000_add_scheduled_arrival_date_to_report_uld');
};
