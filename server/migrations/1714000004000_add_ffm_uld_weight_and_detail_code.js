...
exports.up = (pgm) => {
  pgm.sql(`
    ALTER TABLE ffm_uld
      ADD COLUMN IF NOT EXISTS uld_weight NUMERIC(14, 3),
      ADD COLUMN IF NOT EXISTS uld_detail_code TEXT;
...
exports.down = () => {
  throw new Error('Down migration is not supported for 1714000004000_add_ffm_uld_weight_and_detail_code');
};
